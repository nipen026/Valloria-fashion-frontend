    ...
    <section className="relative h-[calc(100vh-130px)] w-full overflow-hidden" aria-label="Velloria Fashion Banner">
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-black/50 z-10 flex items-center">
        ...
        <div className="container text-center mx-auto px-4 text-white max-w-4xl z-20">
          <h1 className="text-white text-4xl md:text-5xl font-extrabold mb-4 animate-typing whitespace-nowrap overflow-hidden border-r-4 border-white pr-4">
            <span className="block text-center md:hidden">Velloria Fashion</span>
            <span className="hidden md:inline">Velloria Fashion – Elevate Your Style</span>
          </h1>

          <p className="mb-6 text-xl font-light">
            Explore the finest in men’s and women’s fashion with Velloria’s exclusive seasonal collections. From timeless basics to bold new arrivals — we redefine modern fashion.
          </p>
